...
// The code paths that require cgpt_uuid_generate are not used currently in
...
// set to cgpt_uuid_generate in case of the cgpt binary and can be null or some
// no-op method in case of ilbcgpt-cc.a.
void (*uuid_generator)(uint8_t* buffer) ;
void cgpt_uuid_generate(uint8_t* buffer);
