...
typedef enum
{
    ia_aiq_ae_flicker_reduction_off,
    ia_aiq_ae_flicker_reduction_50hz,
    ia_aiq_ae_flicker_reduction_60hz,
...
typedef struct
{
    ...
    int distance_from_convergence;                      /*!< Range [-1000,1000]. Negative is underexposure, positive is overexposure */
...
typedef struct
{
    ...
    ia_aiq_flash_parameters* flash;                     /*!< Flash parameters to be used in the next frame. */
